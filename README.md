...
Domain control is the main controller of your domain, Which controls things like logins, permissions, and security across all computers in the networks. Wihtout domain controller, there is no cantral control. 
